...
html ->
  head ->
    ...
    style type: 'text/css', '''
      ...
      .hidden { display: none }
      .org-info { background-color: #F0FEF0; }
    '''
body ->
  div class: 'topbar', ->
    div class: 'topbar-inner', ->
      div class: 'container-fluid', ->
        ...
        ul class: 'nav', ->
          li class: 'menu', ->
            a href: '#', class: 'menu', 'Действия'
            ul class: 'menu-dropdown', ->
              li -> a href: '#', 'Удалить компанию'
              li -> a href: '#', 'Создать компанию'
              li class: 'divider'
              li -> a href: '#', 'Добавить сотрудника'
              li -> a href: '#', 'Удалить сотрудника'

        ul class: 'nav', ->
          li class: 'menu', ->
            a href: '#', class: 'menu', 'Сотрудники'
            ul class: 'menu-dropdown', ->
              li ->
                a href:'/#/taras', 'Атаманкин Тарас'
              li ->
                a href:'#', 'Пынзарь Станислав'
